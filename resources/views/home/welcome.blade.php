              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="team-item-1">
                    <img src="{{ str_replace('public/',' ',url()->full()).Storage::url('app/public'.$rec->client_image_logo)}}" onmouseover="this.src={{ str_replace('public/',' ',url()->full()).Storage::url('app/public'.$rec->client_image_logo)}}" onmouseout="this.src={{ str_replace('public/',' ',url()->full()).Storage::url('app/public'.$rec->client_image_logo)}}" alt="Team 1" style="width: 200px;height: 170px;">
                    <div class="team-info text-center mb-10">
                      <p class="name">{{$rec->client_name}}</p>
                      <p class="position"></p>
                    </div>
                  </div>
                </div>
